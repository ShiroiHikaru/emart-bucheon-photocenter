...
export default function Home() {
  ...
  <LayerBox image="/images/send_email.jpg" title="이메일 접수" description={`ephoto0401@naver.com 으로 보내주시면\n파일 확인 후 고객님의 카카오톡으로 연락드리겠습니다.\n\n이메일 접수 시 고객님의 성함, 연락처, 인화 규격을\n남겨주시면 보다 원활한 상담을 받으실 수 있습니다.`} />
  <LayerBox image="/images/visit_studio.jpg" title="매장방문 접수" description={`매장방문을 통해 전문가와 상담하신 후 촬영 및 인화,\n각종 사진관련 문의를 상담 받으실 수 있습니다.\n\n[영업시간]\n\n오전 10시 ~ 오후 08시\n주 2,4주차 일요일 휴무 (이마트와 동일)\n\n[매장 전화번호] 032)652-4782`} />
</div>
      </section>
    </main>
  )
